...
class HttpParser(MakefilePackage):
    ...
    cpe = {
            '2.9.4':'cpe:2.3:a:nodejs:http-parser:2.9.4',
            '2.9.3':'cpe:2.3:a:nodejs:http-parser:2.9.3',
            '2.9.2':'cpe:2.3:a:nodejs:http-parser:2.9.2',
            '2.9.1':'cpe:2.3:a:nodejs:http-parser:2.9.1',
    }
